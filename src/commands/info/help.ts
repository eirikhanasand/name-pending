import { SlashCommandBuilder, EmbedBuilder, ChatInputCommandInteraction, EmbedField } from 'discord.js'
...
async function help(message: ChatInputCommandInteraction, command: string | null) {
