...
export async function execute(message) {
    ...
    const status = new EmbedBuilder()
        ...
        .setTimestamp()
        .addFields({ name: "Total", value: `${info.total}`, inline: true }, { name: "Cooldown", value: `${cooldown}`, inline: true }, { name: " ", value: " ", inline: false }, { name: "Domains", value: `${info.domains}`, inline: true }, { name: "Paths", value: `${info.paths}`, inline: true });
