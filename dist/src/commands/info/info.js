...
export async function execute(message) {
    ...
    const embed = new EmbedBuilder()
        ...
        .setColor("#fd8738")
        .setTimestamp()
        .addFields({ name: "Created", value: "21.08.23", inline: true }, { name: "Updated", value: "26.08.23", inline: true }, { name: " ", value: " ", inline: false }, { name: "Domains", value: `${info.domains}`, inline: true }, { name: "Paths", value: `${info.paths}`, inline: true });
