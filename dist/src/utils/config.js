...
const { DISCORD_CLIENT_ID, DISCORD_GUILD_ID, DISCORD_STYRET_ROLE_ID, DISCORD_TEKKOM_ROLE_ID, DISCORD_MINECRAFT_LOG_CHANNEL_ID, DISCORD_TOKEN, MINECRAFT_URL, MINECRAFT_SURVIVAL, MINECRAFT_CREATIVE, MINECRAFT_SURVIVAL_PORT, MINECRAFT_CREATIVE_PORT, MINECRAFT_PORT, API } = process.env;
