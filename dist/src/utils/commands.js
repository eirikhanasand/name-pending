const page1 = [
    ...
    "add                                     Adds a user or role to the current ticket and pings them",
    "addviewer                        Adds a user or role to the current ticket without pinging",
    "chat                                   Links Minecraft chats to the current channel",
    "close                                  Closes a ticket",
    "create                                Creates a new ticket",
    "get                                      Gets all your tickets (planned feature)",
...
const page2 = [
    ...
    "remove                              Removes a user or role from the current ticket",
    "reopen                               Reopens a archived ticket",
