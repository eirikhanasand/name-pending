import { ActionRowBuilder, ButtonBuilder, ButtonStyle, EmbedBuilder, StringSelectMenuBuilder, TextChannel } from "discord.js";
import { getTickets } from "./ticket.js";
export default async function invite(interaction) {
...
export async function inviteToTicket(interaction) {
...
export async function joinTicket(interaction) {
    // Finds the ID of the ticket the user wants to join
    const id = findTicketID(interaction.message.embeds[0].data.title);
